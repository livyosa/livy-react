      ...
      <div className="max-w-[62.5rem] mx-auto px-6">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-2">Logo</p>
              <p className="font-medium text-gray-800">Pacifico Regular</p>
              <p className="text-gray-600 mt-1">62px · line-height 1.1</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-2">Headings</p>
              <p className="font-medium text-gray-800">Mukta Vaani 800 / 600 / 400</p>
              <p className="text-gray-600 mt-1">32 / 24 / 20 / 16px</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-2">Body</p>
              <p className="font-medium text-gray-800">Mukta Vaani Light 300</p>
              <p className="text-gray-600 mt-1">14px · line-height 1.6</p>
            </div>
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-2">Indicia</p>
              <p className="font-medium text-gray-800">Merriweather Regular</p>
              <p className="text-gray-600 mt-1">12px · line-height 1.6</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="grid md:grid-cols-2 gap-10">
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-3">Growth</p>
              <div className="flex gap-3 flex-wrap">
                {greens.map((c) => (
                  <div key={c.hex} className="text-center">
                    ...
                    />
                    <p className="text-xs text-gray-700">{c.name}</p>
                    <p className="text-[11px] text-gray-500">{c.hex}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500 mb-3">Warmth</p>
              <div className="flex gap-3 flex-wrap">
                {golds.map((c) => (
                  <div key={c.hex} className="text-center">
                    <div
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-xs uppercase tracking-wide text-gray-500 mb-5">Iconography</p>
          <img
            src={icons}
            alt="GrowthMind original iconography set"
